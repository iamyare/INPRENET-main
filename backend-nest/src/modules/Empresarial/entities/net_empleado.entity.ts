...
export class Net_Empleado  {
  ...
  @Column('varchar2', { nullable: true, name: 'DIRECCION' })
  direccion: string;

  @Column('varchar2', { nullable: true, name: 'N_CASA' })
  n_casa: string;
  ...
  @Column('varchar2', { nullable: true, name: 'OTRO_PUNTO_REFERENCIA' })
  otro_punto_referencia: string;
