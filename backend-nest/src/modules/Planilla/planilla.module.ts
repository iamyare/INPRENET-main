...
@Module({
  ...
  imports: [
    TypeOrmModule.forFeature([Beneficio, DetallePagoBeneficio, Planilla, Deduccion, TipoPlanilla, DetalleDeduccion, Institucion, Afiliado,
       DetalleAfiliado, DetalleBeneficioAfiliado,TipoDeduccion]),]
})
