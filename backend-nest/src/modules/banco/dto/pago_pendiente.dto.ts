...
export class NotificacionPagosPendientesDto {
  ...
  @IsDefined({ message: 'El monto pagado debe estar definido.' })
  ...
  @IsDefined({ message: 'El número de cuenta debe estar definido.' })
  ...
  @IsDefined({ message: 'La fecha de actualización debe estar definida.' })
  ...
  @IsDefined({ message: 'El código del banco debe estar definido.' })
  ...
  @IsDefined({ message: 'El monto total pagado debe estar definido.' })
  ...
  @IsDefined({ message: 'La descripción de resolución debe estar definida.' })
  ...
  @IsDefined({ message: 'Los pagos acumulados deben estar definidos.' })
