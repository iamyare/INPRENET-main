...
export class NET_TIPO_MOVIMIENTO {
    @PrimaryColumn({type: 'int', name: 'ID_TIPO_MOVIMIENTO',primaryKeyConstraintName: 'PK_TIPO_MOVIMIENTO'})
    ID_TIPO_MOVIMIENTO: number;

    @PrimaryColumn({type: 'int', name: 'ID_TIPO_CUENTA',primaryKeyConstraintName: 'PK_TIPO_MOVIMIENTO'})
